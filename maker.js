...
(function initHomeCategories(){
  ...
  categories.forEach(function(category){
    ...
    else if(category[0]==='create')panel.innerHTML='<div class="tool-grid"><a class="tool-card" href="tools/social-canvas.html"><div class="tool-icon">▣</div><h3>Social Canvas</h3><p>Place an image on a social-ready canvas, add a message, and export it locally.</p><span class="tool-arrow">Open tool →</span></a></div>';
