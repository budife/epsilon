...
(function initHomeCategories(){
  ...
  var homeStyle=document.createElement('style');homeStyle.textContent='.home{height:100vh;min-height:0;display:flex;flex-direction:column;overflow:hidden}.home-header{flex-shrink:0;padding-top:24px;padding-bottom:18px}.home-logo{width:58px;height:58px}.home-header h1{font-size:34px}.tools-wrap{width:100%;flex:1;min-height:0;overflow-y:auto}.home-footer{display:flex;align-items:center;justify-content:space-between;gap:24px;margin-top:auto;padding:15px max(7vw,36px);border-top:1px solid #dce3e8;background:#fff;color:#8a959d;font-size:11px;text-align:left;flex-shrink:0}.home-footer p{margin:0}.home-footer .creator-link{position:relative;cursor:pointer;color:#53606b;font-weight:700;text-decoration:none}.home-footer .creator-link:hover{color:#db0011}.home-footer .creator-tooltip{position:absolute;bottom:calc(100% + 8px);left:0;transform:none;padding:6px 10px;border-radius:4px;background:#17212b;color:#fff;font-size:10px;font-weight:400;white-space:nowrap;opacity:0;pointer-events:none;transition:opacity .15s ease}.home-footer .creator-link:hover .creator-tooltip{opacity:1}.home-footer .social-links{display:flex;align-items:center;gap:8px}.home-footer .social-links a{display:grid;place-items:center;width:30px;height:30px;border:0;border-radius:8px;background:#f3f6f8;color:#71808c;transition:color .15s ease,background .15s ease,transform .15s ease}.home-footer .social-links a:hover{background:#fff0f1;color:#db0011;transform:translateY(-2px)}.tool-grid{grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.tool-card{position:relative;display:flex;flex-direction:column;overflow:hidden;min-height:148px;padding:17px 18px;background:linear-gradient(145deg,#fff 0%,#fbfcfd 100%);border:1px solid #e1e7eb;border-radius:10px;box-shadow:0 4px 12px rgba(31,48,62,.045);transition:transform .2s ease,box-shadow .2s ease,border-color .2s ease,background .2s ease}.tool-card::after{content:"";position:absolute;right:-34px;bottom:-34px;width:100px;height:100px;border-radius:50%;background:#fff0f1;opacity:0;transform:scale(.6);transition:opacity .2s ease,transform .2s ease}.tool-card:hover{transform:translateY(-3px);border-color:#ffb9be;background:#fff;box-shadow:0 13px 25px rgba(31,48,62,.12)}.tool-card:hover::after{opacity:1;transform:scale(1)}.tool-card:hover .tool-icon{transform:scale(1.06);background:#ffe8ea}.tool-icon{position:relative;z-index:1;width:38px;height:38px;margin-bottom:12px;border-radius:9px;background:#fff0f1;color:var(--red);font-size:19px;transition:transform .2s ease,background .2s ease}.tool-card h3{position:relative;z-index:1;margin:0 0 6px;font-size:15px;line-height:1.2;letter-spacing:-.1px}.tool-card p{position:relative;z-index:1;margin:0;color:#71808c;font-size:11px;line-height:1.4}.tool-arrow{position:relative;z-index:1;margin-top:auto;padding-top:12px;color:var(--red);font-size:11px;font-weight:700}.tool-workflow{position:absolute;top:12px;right:14px;z-index:2;color:#9aa5af;font-size:8px;font-weight:700;letter-spacing:.8px;text-transform:uppercase}.tool-card:hover .tool-workflow{color:#db0011}@media(max-width:1100px){.tool-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:820px){.tool-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:620px){.home-footer{display:block;padding:12px 20px;text-align:center}.home-footer .social-links{justify-content:center;margin-top:9px}.tool-grid{grid-template-columns:1fr}}';document.head.appendChild(homeStyle);
