...
(function initHomeCategories(){
  ...
  categories.forEach(function(category){
    ...
    else if(category[0]==='create')panel.innerHTML='<div class="tool-grid"><a class="tool-card" href="tools/social-canvas.html"><div class="tool-icon">▣</div><h3>Social Canvas</h3><p>Place an image on a social-ready canvas, add a message, and export it locally.</p><span class="tool-arrow">Open tool →</span></a><a class="tool-card" href="tools/presentation-board.html"><div class="tool-icon">▤</div><h3>Presentation Board</h3><p>Arrange visuals into a clean board for review, presentation, or delivery.</p><span class="tool-arrow">Open tool →</span></a></div>';
    else if(category[0]==='prepare')panel.innerHTML='<div class="tool-grid"><a class="tool-card" href="tools/image-studio.html"><div class="tool-icon">▧</div><h3>Image Studio</h3><p>Resize, convert, compress, and rename images locally in your browser.</p><span class="tool-arrow">Open tool →</span></a><a class="tool-card" href="tools/typography-helper.html"><div class="tool-icon">Tt</div><h3>Typography Helper</h3><p>Build a practical type scale, preview hierarchy, and copy CSS.</p><span class="tool-arrow">Open tool →</span></a></div>';
